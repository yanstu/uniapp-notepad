	...
	<view>
		<view>
			...
			<view class="cu-form-group">
				...
				<input placeholder="请再次输入密码" maxlength="16" name="input" v-model.trim="repassword" />
			</view>
			<button class="cu-btn block bg-blue margin-top-lg lg margin-left margin-right" @click="submit" :disabled="loading" :loading="loading">
				<text class="padding-left-sm">注册</text>
			</button>
			<view class="text-sm padding text-gray">注册账号后自动登录</view>
		</view>
	</view>
</template>
